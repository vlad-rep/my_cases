...
class MessageView(LoginRequiredMixin, generic.CreateView):
    model = Message
    ...
    def post(self, request, *args, **kwargs):
        ...
        if message and sender:
            ...
            recipient_message = render_to_string('message-html.html', args)
            sender_message = render_to_string('message-html.html', args)
